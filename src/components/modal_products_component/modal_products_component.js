...
import { Product_state } from '../grid_products_component/grid_products_component'; // Importe o objeto Product_state aqui

const Modal_product_component = ({ id, product, onClose }) => {
  const { totalAdditional, totalPrice, additionalStates, handleIncrement, handleDecrement } = useAdditionalState();
          ...
          <div className="modal-body">
            ...
            <div className='options-container'>
              <div className='options-container-head'>
                <h5>Adicionais</h5>
                <h6><span id='add'>{totalAdditional}</span>/10</h6>
              </div>
            </div>
            ...
            {additionalStates.map(additional => (
              <div key={additional.id} className='options-description-container'>
                <div className='options-additions'>
                  <p>{additional.description} - <span id='additional-value'>R$2,50</span></p>
                </div>
