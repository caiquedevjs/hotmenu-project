...
// Funções helpers de data e estoque
              ...
              <div className="container-sm">
                ...
                <div id='card_container' onClick={() => openProductDetails(product)} style={{ cursor: 'pointer' }}>
                  <div id='text_category'>
                    ...
                    <img src={`https://hotmenu.com.br/arquivos/${product.Foto}`} className='product-img' alt={product.Nome} />
                  </div>
                </div>
              </div>
            </div>
