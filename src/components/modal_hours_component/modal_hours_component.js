...
import { fetchHorarioFuncionamento } from '../service/productService'; // Ajuste o caminho conforme necessário
      ...
      <div className="modal-dialog">
        <div className="modal-content">
          <div className="modal-header">
            <h3 id='info_text'>
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-alarm-fill" viewBox="0 0 16 16" style={{ color: '#ce2929' }}>
            ...
            {hoursData.horarios.length > 0 ? (
              hoursData.horarios.map((horario) => (
                <div key={horario.DiaDaSemana}>
                  <p style={{ color: horario.DiaDaSemana === currentDay ? '#ce2929' : 'black' }}>
